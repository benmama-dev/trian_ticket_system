    ...
    <section>
        <nav>
            ...
            <ul>
                ...
                <li><a href="login.php" onclick="return confirm('กรุณาเข้าสู่ระบบก่อน?')">ประวัติการซื้อตั๋ว</a></li>
                <li><a href="login.php" onclick="return confirm('กรุณาเข้าสู่ระบบก่อน?')">เปลี่ยนแปลงตั๋ว </a></li>
                <li><a href="login.php" onclick="return confirm('กรุณาเข้าสู่ระบบก่อน?')">ยกเลิกตั๋วโดยสาร</a></li>
            ...
            <div class="container blog-shadow-two bg-head p-2 ">
                <div class=" row m-lg-3 col-20">
                    ...
                    <div class="col-4 col-sm-2 border-ed-2 p-0">
                        <input type="date" name="date" id="form3Example4" value="วันที่เดินทาง" class="form-control" style="text-align: center; width: 180px; height: 59px; border-color: #C48A0e ;" required />
                    </div>
                    ...
                    <div class="col-3 col-sm-1 button-1 p-0">
                        <!-- <form action="login.php"> -->
                        <button style="width: 85px; height: 59px; background-color:#C48A0e; " type="submit" name="submit1" class="btn btn-primary" onclick="return confirm('คุณต้องเข้าสู่ระบบก่อน')  ">ค้นหา</button>
                        <!-- </form> -->
                    </div>
