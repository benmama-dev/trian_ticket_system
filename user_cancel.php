                                ...
                                <tbody class="text-center">
                                    <?php foreach ($result as $data) :  ?>
                                        <tr>
                                            ...
                                            <td><?= $data['Quantity'] ?></td>
                                            <td><?= $data['Amount'] ?></td>
                                            <td><a href="delete_order_db.php?Order_Id=<?php echo $data['Order_Id'] ?>" onclick="return confirm('คุณต้องการลบหรือไม่')" class="btn  btn-danger">ลบ</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
