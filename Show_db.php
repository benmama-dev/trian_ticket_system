                    ...
                    <div class="col-md-8 border-right">
                        <div class="p-1 py-5">
                            ...
                            <form action="tets.php" method="POST">
                                <div class="col-md-12">
                                    <table class="table table-striped" border="1" cellpadding="0" cellspacing="0" align="center" id="myTable">
                                        ...
                                        $sql = "SELECT t.Travel_Id,r.Source,r.Destination,t.Time_Date
                                            ...
                                            WHERE  r.Source LIKE '%$Source%' AND r.Destination LIKE '%$Destination%' AND t.Time_Date LIKE '$Time_Date'" or die("Error" . mysqli_error($connect));
                                        ...
                                        <tbody class="text-center">
                                            <?php foreach ($result as $data) : ?>
                                                ...
                                                <tr>
                                                    <td><?php echo $data['Travel_Id']; ?></td>
                                                    <td><?php echo $data['Source']; ?></td>
                                                    <td><?php echo $data['Destination']; ?></td>
                                                    <td><?php echo $data['Time_Date']; ?></td>
                                                    <td><a href="order.php?Travel_Id=<?php echo $data['Travel_Id'] ?>" class="btn btn-warning">จอง</a></td>
                                                </tr>
                                            <?php endforeach; ?>
