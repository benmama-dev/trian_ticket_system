                        ...
                        <div class="p-1 py-5">
                            ...
                            <table class="table table-striped" id="myTable">
                                <thead class="text-center">
                                    <tr>
                                        <th scope="col">เลขที่ตั๋ว</th>
                                        <th scope="col">วันที่ออกตั๋ว</th>
                                ...
                                <tbody class="text-center">
                                    <?php foreach ($result as $data) :  ?>
                                        <tr>
                                            ...
                                            <td><?= $data['Quantity'] ?></td>
                                            <td><?= $data['Amount'] ?></td>
                                            <td><button type="button" class="btn btn-warning updateTravel" id="<?php echo $data['Order_Id'] ?>">แก้ไข</button></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="update-form">
                        ...
                        <input type="date" class="form-control form-control-lg" name="Travel_date" id="Travel_date">
